...
async function main() {
    ...
    // Mapping them to relevant meal images since no dedicated category folder exists
    // Prefixing with 'uploads/' for frontend compatibility
    const categories = [
    ...
    // Using images from uploads/providers
    ...
    // Using images from uploads/meals
