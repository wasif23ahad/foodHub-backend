...
export const initPayment = async (req: Request, res: Response) => {
    try {
        ...
        const data = {
            ...
            cus_name: (order.customer.name || 'Customer').substring(0, 50),
            cus_email: order.customer.email.substring(0, 50),
            cus_add1: order.deliveryAddress.substring(0, 50),
            cus_add2: order.deliveryAddress.substring(0, 50),
            cus_city: 'Dhaka',
            cus_state: 'Dhaka',
            cus_postcode: '1000',
            cus_country: 'Bangladesh',
            cus_phone: (order.customer.phone || '01711111111').substring(0, 20),
            cus_fax: (order.customer.phone || '01711111111').substring(0, 20),
            ship_name: (order.customer.name || 'Customer').substring(0, 50),
            ship_add1: order.deliveryAddress.substring(0, 50),
            ship_add2: order.deliveryAddress.substring(0, 50),
            ship_city: 'Dhaka',
            ship_state: 'Dhaka',
            ship_postcode: '1000',
