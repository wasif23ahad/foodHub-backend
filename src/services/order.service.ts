 ...
 */
export const getProviderOrders = async (providerId: string, query: OrderQueryInput) => {
 ...
 */
export const getProviderOrderById = async (orderId: string, providerId: string) => {
 ...
 */
export const getCustomerOrders = async (userId: string, query: OrderQueryInput) => {
    const { status, page, limit } = query;
 ...
 */
export const getCustomerOrderById = async (orderId: string, userId: string) => {
    const order = await prisma.order.findUnique({
        where: { id: orderId },
        include: {
            providerProfile: {
